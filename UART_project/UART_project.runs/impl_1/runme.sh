...
HD_PWD='C:/Users/tamka/OneDrive/Documents/Vivado_projects/UART_project/UART_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_txrx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_txrx.tcl -notrace
