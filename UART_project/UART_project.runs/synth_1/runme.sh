...
HD_PWD='C:/Users/tamka/OneDrive/Documents/Vivado_projects/UART_project/UART_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_txrx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_txrx.tcl
